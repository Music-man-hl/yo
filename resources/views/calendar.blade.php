                ...
                <div class="col-md-3">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h4 class="box-title">拖放事件</h4>
                        </div>
                        <div class="box-body">
                            <!-- the events -->
                            <div id="external-events">
                                <div class="external-event bg-green">午餐</div>
                                <div class="external-event bg-yellow">回家</div>
                                <div class="external-event bg-aqua">做作业</div>
                                <div class="external-event bg-light-blue">编程工作</div>
                                <div class="external-event bg-red">一夜好梦</div>
                                <div class="checkbox">
